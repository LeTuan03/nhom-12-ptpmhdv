...
import { deleteBooking, getAllBooking } from "./booking-service";
        ...
        <SoftBox mb={3}>
          <Card>
            ...
            <SoftBox>
              ...
              {openEdit && <BookingDialog open={openEdit} handleClose={handleClose} handleOk={handleSearch} item={state?.item} />}
